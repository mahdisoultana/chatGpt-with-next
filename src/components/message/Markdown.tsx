...
import oneDark from 'react-syntax-highlighter/dist/cjs/styles/prism/one-dark'; // Choose your preferred syntax highlighting style
import { toast } from 'react-toastify';
function MarkdownData({ children }: { children: string }) {
  ...
  return b ? (
    <Markdown className="w-full  " options={options}>
      {children}
    </Markdown>
  ) : null;
}
