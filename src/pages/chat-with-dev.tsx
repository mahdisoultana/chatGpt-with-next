...
function ChatWithDev(props: GetServerSideProps) {
  ...
  return (
    <AppContext>
      <div className="min-h-screen   w-full bg-gray-900  overflow-x-hidden  h-screen overflow-y-auto flex items-start justify-center text-white  ">
